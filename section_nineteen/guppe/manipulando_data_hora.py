"""
Manipulando Data eh Hora

Python tem um modulo built-in (integrado) para se trabalhar com data eh hora
chamado datetime
...
# Retorna a data eh hora corrente
...
# Alterar o horario para 16 horas, 0 minuto, 0 segund, 0 microsegundo
inicio = inicio.replace(year=2023, hour=16, minute=0, second=0, microsecond=0)

print(inicio)

# Recebendo dados do usuario eh convertendo para data
print(type(evento))
...
# Acessa individual dos elementos de data eh hora
